...
Отключить DHCP для определения DNS сервера: понятия не имею. Хотелось бы узнать у разрабов wlan0 почему они не оставили возможность отключить запрос DNS по DHCP.
